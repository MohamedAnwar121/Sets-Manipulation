...
public class UI {
    ...
    public static void UIForPart1(){
        ...
        switch (operation){
            case 1 :
                ...
                System.out.printf("bit number %d = %d" ,pos ,bits.getBit(number,pos-1));
                break;
            case 2 :
                System.out.println("---------------------------------");
                System.out.println("Enter a number and the position of the bit :");
                ...
                System.out.printf("Number after setting bit number %d = %d",pos,bits.setBit(number,pos-1));
                break;
            case 3 :
                System.out.println("---------------------------------");
                System.out.println("Enter a number and the position of the bit :");
                ...
                System.out.printf("Number after clearing bit number %d = %d",pos,bits.clearBit(number,pos-1));
                break;
            case 4 :
                System.out.println("---------------------------------");
                ...
                System.out.printf("Number after updating bit number %d = %d",pos,bits.updateBit(number,pos-1, value != 0));
                break;
            case 5 :
                System.out.println("------------------------------------------------");
                new UI();
    ...
    public static void UIForPart2(){
        ...
        for (int i = 0; i < setsSize; i++) {
            ...
            int setSize = scan.nextInt();System.out.println("------------------------------------------------");
